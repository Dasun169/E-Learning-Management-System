...
const SE_New = ({ userName, role }) => {
  ...
  useEffect(() => {
    const fetchAllCourses = async () => {
      try {
        const fetchPromises = [
          fetch("http://localhost:8080/api/courses/search-by-name/CSCI"),
          fetch("http://localhost:8080/api/courses/search-by-name/CSEC"),
          fetch("http://localhost:8080/api/courses/search-by-name/CTEC"),
