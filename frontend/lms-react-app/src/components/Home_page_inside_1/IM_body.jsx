...
const IM_New = ({ userName, role }) => {
  ...
  useEffect(() => {
    const fetchAllCourses = async () => {
      try {
        const fetchPromises = [
          fetch("http://localhost:8080/api/courses/search-by-name/INTE"),
          fetch("http://localhost:8080/api/courses/search-by-name/MGTE"),
