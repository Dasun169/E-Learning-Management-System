...
const Micro_New = ({ userName, role }) => {
  ...
  useEffect(() => {
    const fetchAllCourses = async () => {
      try {
        const fetchPromises = [
          fetch("http://localhost:8080/api/courses/search-by-name/MIBI"),
          fetch("http://localhost:8080/api/courses/search-by-name/PLBL"),
